...
build_test:
	docker-compose exec aes g++ $(FLAGS) -g -pthread ./src/AES.cpp ./src/AESUtils.cpp ./tests/tests.cpp /usr/lib/libgtest.a -o bin/test

build_debug:
	docker-compose exec aes g++ $(FLAGS) -g ./src/AES.cpp ./src/AESUtils.cpp ./dev/main.cpp -o bin/debug

build_profile:
	docker-compose exec aes g++ $(FLAGS) -pg ./src/AES.cpp ./src/AESUtils.cpp ./dev/main.cpp -o bin/profile

build_speed_test:
	docker-compose exec aes g++ $(FLAGS) -O2 ./src/AES.cpp ./src/AESUtils.cpp ./speedtest/main.cpp -o bin/speedtest

build_release:
	docker-compose exec aes g++ $(FLAGS) -O2 ./src/AES.cpp ./src/AESUtils.cpp ./dev/main.cpp -o bin/release
